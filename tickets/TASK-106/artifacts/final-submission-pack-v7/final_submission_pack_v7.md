...
- `hero_video_duration_s`: `60.0`
- `hero_video_path`: `artifacts/runs/task97-runpod-overlay-v2/generated-base-animals-0076-visual-noise-000_ood.mp4`
...
| We have a judge-visible CARLA OOD video for the generated simulator path. | proved | artifacts/runs/task97-runpod-overlay-v2/generated-base-animals-0076-visual-noise-000_ood.mp4 | Hero video duration is 60.0 seconds. | scripted simulator evidence; not an official Fail2Drive route score. |
...
- `hero_video_evidence_path`: `tickets/archive/TASK-097/artifacts/pulled/artifacts/runs/task97-runpod-overlay-v2/ood_video_evidence.json`
