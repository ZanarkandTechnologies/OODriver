...
- exit_code: `1`
- duration_s: `2.489098`
- stdout: `/workspace/0xDriver/tickets/TASK-068/artifacts/town13-route-run-after-local-demo/logs/fail2drive_route.stdout.log`
- stderr: `/workspace/0xDriver/tickets/TASK-068/artifacts/town13-route-run-after-local-demo/logs/fail2drive_route.stderr.log`
...
|---|---:|---:|---|
| `result` | `False` | `None` | `/workspace/0xDriver/tickets/TASK-060/artifacts/town13-video-plan/fail2drive_outputs/Generalization_PedestriansOnRoad_1088_res.json` |
...
| `save_path` | `False` | `None` | `/workspace/0xDriver/tickets/TASK-060/artifacts/town13-video-plan/fail2drive_outputs/visualizations` |
| `rgb_folder` | `False` | `None` | `/workspace/0xDriver/tickets/TASK-060/artifacts/town13-video-plan/fail2drive_outputs/visualizations/Generalization_PedestriansOnRoad_1088/rgb` |
...
- Fail2Drive Python dependency is missing: torch.
- RGB frames were not produced by Fail2Drive route run: /workspace/0xDriver/tickets/TASK-060/artifacts/town13-video-plan/fail2drive_outputs/visualizations/Generalization_PedestriansOnRoad_1088/rgb