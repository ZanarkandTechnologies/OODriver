...
| detect_risk | proved | 281 events, max_risk=critical | Simulator ground truth creates a timeline of what the autonomy stack should notice. |
...
- `risk_timeline_path`: `tickets/TASK-110/artifacts/risk-timeline-v1/risk_timeline.json`
