...
- location: `src/driverx/pipeline/alpamayo_ood_evaluation.py`, `tickets/TASK-056/artifacts`
...
- Expected artifacts: `tickets/TASK-056/artifacts/*`

### Evidence Checklist
- [x] Comparison JSON:
  `tickets/TASK-056/artifacts/town10-memory-comparison/alpamayo_ood_comparison.json`
- [x] Comparison report:
  `tickets/TASK-056/artifacts/town10-memory-comparison/alpamayo_ood_comparison.md`
- [x] Memory-augmented live Alpamayo decision:
  `tickets/TASK-056/artifacts/live-memory-run-summary/alpamayo_policy_decision.json`
- [x] Focused tests log
...
- `tickets/TASK-056/artifacts/town10-memory-comparison/alpamayo_ood_comparison.md`
- `tickets/TASK-056/artifacts/live-memory-run-summary/alpamayo_policy_decision.json`
- `tickets/TASK-056/artifacts/live-memory-run/alpamayo_live_prediction.json`

### User Evidence
- Supporting evidence: baseline Alpamayo vs memory-augmented Alpamayo trajectory
  delta is captured in the comparison report.
- QA report: `tickets/TASK-056/artifacts/qa_report.md`
- Review: `tickets/TASK-056/artifacts/review.md`
