...
- Expected artifacts: `tickets/archive/TASK-054B/artifacts/*`

### Evidence Checklist
- [x] Docker build log:
  `tickets/archive/TASK-054B/artifacts/docker_build.log`
- [x] Docker build log with optional Torch:
  `tickets/archive/TASK-054B/artifacts/docker_build_torch.log`
- [x] Docker import smoke:
  `tickets/archive/TASK-054B/artifacts/docker_import_smoke.log`
- [x] Docker import smoke with Torch and CARLA agents:
  `tickets/archive/TASK-054B/artifacts/docker_import_smoke_torch_agents.log`
...
- [x] Town10 fallback route run report:
  `tickets/archive/TASK-054B/artifacts/docker-route-run-town10-speedlimit/fail2drive_route_run.md`
- [x] Town10 route video assembly:
  `tickets/archive/TASK-054B/artifacts/route-video-town10-speedlimit/route_video_assembly.md`
- [x] QA report:
...
### Artifact Links
- `tickets/archive/TASK-054B/artifacts/docker-route-run-town13-map-blocker-classified/fail2drive_route_run.json`
- `tickets/archive/TASK-054B/artifacts/docker-route-run-town10-speedlimit/fail2drive_route_run.json`
- `tickets/archive/TASK-054B/artifacts/route-video-town10-speedlimit/route_video_assembly.json`
...
- QA report: `tickets/archive/TASK-054B/artifacts/qa_report.md`
