...
- cataloged scenarios: `1`
- scenarios with video: `1`
- scenarios with VLA reasoning: `0`
- policy evaluations by status: passed `0`, planned `0`, blocked `0`
- local decision artifacts attached: `0`

## Hero Candidates

- `generated-base-animals-0076-visual-noise-000`: behavior `wrong_way_shoulder_creep`, video `True`, reasoning `False`
