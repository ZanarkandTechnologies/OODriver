...
def register_fail2drive_commands(subparsers: Any) -> None:
    ...
    run_route.add_argument("--agent", choices=["pdm-lite", "human", "transfuser", "custom"], default="pdm-lite")
    ...
    evaluate.add_argument("--agent", choices=["pdm-lite", "human", "transfuser", "custom"], default="pdm-lite")
